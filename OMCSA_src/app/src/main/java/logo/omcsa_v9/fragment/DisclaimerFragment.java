...
public class DisclaimerFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.fragment_disclaimer, container, false);
        mContext.doShowSearchButton(false);
        showBackButton(true);
        ourWebViewClient webViewClient = new ourWebViewClient("https://omcsa.org/disclaimer");
        ((WebView)mRootView.findViewById(R.id.webView)).setWebViewClient(webViewClient);
        ((WebView)mRootView.findViewById(R.id.webView)).loadUrl("https://omcsa.org/disclaimer");
